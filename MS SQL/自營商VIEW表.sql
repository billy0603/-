...
,ROUND((select F_BQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_BQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE),0) AS '外資多單'
, ROUND(((select F_BQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_BQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)
	-LAG((select F_BQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_BQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)) 
	 OVER (ORDER BY O.DATE)),0) AS '外資多單差額'

,ROUND((select F_SQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_SQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE),0) AS '外資空單'

, ROUND(((select F_SQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_SQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)
	-LAG((select F_SQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_SQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)) 
	 OVER (ORDER BY O.DATE)),0) AS '外資空單差額'

 ,ROUND((select F_BQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_BQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)
	-(select F_SQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	-(select F_SQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE),0) AS '餘額'

 ,ROUND((((select F_BQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_BQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)
	-(select F_SQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	-(select F_SQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE))-LAG(((select F_BQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	+(select F_BQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE)
	-(select F_SQTY_TOTAL from PROD_FUTUER_DTAT where SYMBOLNAME ='TXF' and ID = 1  and DATE=O.DATE)
	-(select F_SQTY_TOTAL/4 from PROD_FUTUER_DTAT where SYMBOLNAME ='MXF' and ID = 1  and DATE=O.DATE))) 
...
join PROD_OHLCV OH
on O.DATE=OH.DATE
where O.ID =1 and O.SYMBOLNAME='TXO' and OH.SYMBOLNAME='TXF'
